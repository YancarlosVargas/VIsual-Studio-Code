...
AlumnosAdministracion === 0 ? alert("No hay alumnos en administracion.") : alert(`El promedio de salario de los alumnos de administracion es de ${PromedioAdministracion / ContadorDeAdministracion}`);
